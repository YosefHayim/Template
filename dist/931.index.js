...
/* harmony export */   kCancel: () => (/* binding */ kCancel),
/* harmony export */   prompt: () => (/* binding */ prompt)
/* harmony export */ });
/* harmony import */ var node_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7975);
/* harmony import */ var node_process__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1708);
/* harmony import */ var node_readline__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(481);
/* harmony import */ var node_tty__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7066);
...
function ce(){return node_process__WEBPACK_IMPORTED_MODULE_1__.platform!=="win32"?node_process__WEBPACK_IMPORTED_MODULE_1__.env.TERM!=="linux":!!node_process__WEBPACK_IMPORTED_MODULE_1__.env.CI||!!node_process__WEBPACK_IMPORTED_MODULE_1__.env.WT_SESSION||!!node_process__WEBPACK_IMPORTED_MODULE_1__.env.TERMINUS_SUBLIME||node_process__WEBPACK_IMPORTED_MODULE_1__.env.ConEmuTask==="{cmd::Cmder}"||node_process__WEBPACK_IMPORTED_MODULE_1__.env.TERM_PROGRAM==="Terminus-Sublime"||node_process__WEBPACK_IMPORTED_MODULE_1__.env.TERM_PROGRAM==="vscode"||node_process__WEBPACK_IMPORTED_MODULE_1__.env.TERM==="xterm-256color"||node_process__WEBPACK_IMPORTED_MODULE_1__.env.TERM==="alacritty"||node_process__WEBPACK_IMPORTED_MODULE_1__.env.TERMINAL_EMULATOR==="JetBrains-JediTerm"}const V=ce(),u=(t,n)=>V?t:n,le=u("❯", ">"),L=u("■", "x"),W=u("▲", "x"),C=u("✔", "√"),o=u(""),d=u(""),k=u("\u25CF",">"),P=u("\u25CB"," "),A=u("\u25FB","[\u2022]"),T=u("\u25FC","[+]"),F=u("\u25FB","[ ]"),w=t=>{switch(t){case "initial":case "active":return e.cyan(le);case "cancel":return e.red(L);case "error":return e.yellow(W);case "submit":return e.green(C)}},B=t=>{const{cursor:n,options:s,style:r}=t,i=t.maxItems??Number.POSITIVE_INFINITY,a=Math.max(process.stdout.rows-4,0),c=Math.min(a,Math.max(i,5));let l=0;n>=l+c-3?l=Math.max(Math.min(n-c+3,s.length-c),0):n<l+2&&(l=Math.max(n-2,0));const $=c<s.length&&l>0,p=c<s.length&&l+c<s.length;return s.slice(l,l+c).map((M,v,x)=>{const j=v===0&&$,E=v===x.length-1&&p;return j||E?e.dim("..."):r(M,v+l===n)})},he=t=>new PD({validate:t.validate,placeholder:t.placeholder,defaultValue:t.defaultValue,initialValue:t.initialValue,render(){const n=`${e.gray(o)}
...
;
//# sourceMappingURL=931.index.js.map